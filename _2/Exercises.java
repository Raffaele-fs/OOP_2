...
public class Exercises {
    ...
    private static void exercise1() {
        ...
        for (int i = 0; i < studentAges.size(); i++) {
            student = new Student(studentNames.get(i), studentAges.get(i));// andiamo a richiamare la classe Student per utilizzare il costruttore Student per i nomi e l'eta'
